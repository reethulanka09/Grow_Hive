...
import ReportedUsersScreen from "./screens/ReportedUsers";
import Proficiency from "./screens/Proficiency";
import BlockedUsers from "./screens/BlockedUsers";

//sELF Service
import KnowledgeNavigator from "./screens/KnowledgeNavigator";
...
function MainTabs({ navigation }) {
  return (
    ...
    >
      ...
      <Tab.Screen
        name="Hackathons"
        component={HackathonsStackScreen}
        options={{ headerShown: false, title: "Hackathons" }}
      />
      <Tab.Screen
        name="Profile"
...
function MainStack() {
  return (
    <Stack.Navigator>
      ...
      />
      <Stack.Screen
        name="PersonChatScreen"
        component={PersonChatScreen}
        options={{ headerShown: false }} // or true, as you prefer
      />
      <Stack.Screen
        name="ChatList"
